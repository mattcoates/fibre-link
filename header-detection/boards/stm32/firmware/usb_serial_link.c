...
#define USB_MEMPOOL_ITEMS 96

/* Function Prototypes */
static void mem_init(void);
static void usb_driver_init(void);
void _upload(log_message *packet);
...
static volatile char usb_mempool_buffer[USB_MEMPOOL_ITEMS * sizeof(log_message)]
...
static THD_FUNCTION(USBThread, arg) {
    ...
    /* Packet Size */
    static const int packet_size = sizeof(log_message);
...
static void mem_init(void) {
    ...
    chPoolObjectInit(&usb_mempool, sizeof(log_message), NULL);
...
void _upload(log_message *packet) {
    ...
    memcpy(msg, (void*)packet, sizeof(log_message));
